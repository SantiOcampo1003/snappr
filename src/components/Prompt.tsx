...
export default function Prompt() {
    ...
    return (
        <div className="flex min-h-400 max-h-screen flex-col items-center justify-between p-24 h-100" >
            <div>
                {
                    messages
    ...
    <div className="w-full">
        <form onSubmit={handleSubmit} className="flex w-full flex-col space-y-2">
            ...
            <button
                ...
                className="bg-purple-600 hover:bg-green-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring focus:border-blue-300 transition duration-300 transform hover:scale-95 active:scale-100" type='submit'>
                send
            </button>
        </form>
    </div>
